...
class ChooseMap():
    def __init__(self, parent, file):
        ...
        for i in range(len(self.maps)):
            ...
            self.mapbtn.append(tk.Button(self.mapbox[i],text="Choose map",width=10,height=1,command=openmap,font=("arial",15)))
...
##        self.mapselectbtn = tk.Label(self.buttonframe,text="Map Selection",command=lambda:self.fileopeningf("mapselect"),width=12,padx=10,pady=20,font=("arial",20))
